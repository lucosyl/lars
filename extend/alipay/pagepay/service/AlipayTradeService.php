...
use alipay\trade\AlipayTradeQueryRequest;
use alipay\request\AlipayTradeRefundRequest;
use alipay\request\AlipayTradeFastpayRefundQueryRequest;
use alipay\request\AlipayTradeCloseRequest;
/* *
 * 功能：支付宝电脑网站支付
 * 版本：2.0
 * 修改日期：2017-05-01
...
require_once EXTEND_PATH."/alipay/aop/request/AlipayTradeFastpayRefundQueryRequest.php";
...
class AlipayTradeService {
	...
	function refundQuery($builder){
		...
		//打印业务参数
		$this->writeLog($biz_content);
		$request = new \alipay\request\AlipayTradeFastpayRefundQueryRequest();
		$request->setBizContent ( $biz_content );
